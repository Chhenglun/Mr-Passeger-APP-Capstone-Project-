...
class TrackingController extends GetxController implements GetxService {
  ...
  //Todo: updatePassengerTokenController
  Future updatePassengerTokenController(String deviceToken ,String passengerId) async {
    try {
      _isLoading = true;
      update();
      Response apiResponse = await trackingRepositiry.updateTokenRepo(deviceToken, passengerId);
