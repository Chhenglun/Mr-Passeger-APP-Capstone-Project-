...
class ExpandableCustomSingleScroll extends StatefulWidget {
  /// [expandableContent] is the widget which you can hide and show by dragging.
  /// It has to be a widget with a constant height. It is required for the [ExpandableCustomSingleScroll].
  final Widget expandableContent;

  /// [background] is the widget behind the [expandableContent] which holds
  /// usually the content of your page. It is required for the [ExpandableCustomSingleScroll].
  ...
  /// [isDraggable] will make the [ExpandableCustomSingleScroll] draggable by the user or not.
  final bool isDraggable;

  /// Creates the [ExpandableCustomSingleScroll].
  ///
  /// [persistentContentHeight] has to be greater 0.
  const ExpandableCustomSingleScroll({
    super.key,
    this.expandableContent = const SizedBox(),
  ...
  @override
  ExpandableCustomSingleScrollState createState() => ExpandableCustomSingleScrollState();
}

class ExpandableCustomSingleScrollState extends State<ExpandableCustomSingleScroll> with TickerProviderStateMixin {
